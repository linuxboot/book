...
Linux needs a root filesystem with at least one binary that is called `init`.
Since booting a system is a cumbersome task, additional tools aid in both
development and investigating possible issues.
